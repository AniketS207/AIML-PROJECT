...
#     'Temperature': [23.220629928291007],
#     'Humidity': [46.073879432102466],
#     'SquareFootage': [1649.5103531928776],
#     'Occupancy': [2],
#     'HVACUsage': ['Off'],
#     'LightingUsage': ['On'],
#     'RenewableEnergy': [18.270528189168942],
#     'DayOfWeek': ['Tuesday'],
#     'Holiday': ['No']
# })
...
# new_data_encoded_aligned = pd.get_dummies(new_data).reindex(columns=X.columns, fill_value=0)
